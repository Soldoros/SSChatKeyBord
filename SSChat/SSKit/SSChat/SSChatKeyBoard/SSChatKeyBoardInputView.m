...
-(instancetype)init{
    if(self = [super init]){
        ...
        [_mLeftBtn setBackgroundImage:[[UIImage imageNamed:@"icon_yuying"]imageWithColor:[UIColor blackColor]] forState:UIControlStateNormal];
        [_mLeftBtn setBackgroundImage:[[UIImage imageNamed:@"icon_shuru"]imageWithColor:[UIColor blackColor]] forState:UIControlStateSelected];
        ...
        [_mAddBtn setBackgroundImage:[[UIImage imageNamed:@"icon_tianjia"]imageWithColor:[UIColor blackColor]] forState:UIControlStateNormal];
        [_mAddBtn setBackgroundImage:[[UIImage imageNamed:@"icon_tianjia"]imageWithColor:[UIColor blackColor]] forState:UIControlStateSelected];
        _mAddBtn.selected = NO;
        ...
        [_mSymbolBtn setBackgroundImage:[[UIImage imageNamed:@"icon_biaoqing"]imageWithColor:[UIColor blackColor]] forState:UIControlStateNormal];
        [_mSymbolBtn setBackgroundImage:[[UIImage imageNamed:@"icon_shuru"]imageWithColor:[UIColor blackColor]] forState:UIControlStateSelected];
...
//           keyboardBounds = [[self getViewController].view convertRect:keyboardBounds toView:nil];
//           cout(@(keyboardBounds.size.height));
//
//        self.bottom = SCREEN_Height - keyboardBounds.size.height;
         
        self.keyBoardStatus = SSChatKeyBoardStatusEdit;
        self.currentBtn.selected = NO;

        if(height==SafeAreaBottom_Height || height==0) {

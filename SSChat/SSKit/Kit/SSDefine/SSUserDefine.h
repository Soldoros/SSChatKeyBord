...
//用户登录后的token
#define USER_Token       [SSAccountManager shareManager].model.token
//用户登录后的userId
#define UserId           [SSAccountManager shareManager].model.userId
//用户登陆后返回的头像
#define USER_HeaderImg   [SSAccountManager shareManager].model.headerImg
